<footer class="footer">
  ...
  <div class="footer_inner">
    <div class="footer_inner-flexBox flex">
      <div class="footer_inner-flexBox-companybox">
        <p class="img">
          <img src="<?php echo esc_url(get_template_directory_uri()); ?>/img/header-logo.png" alt="沖電システム株式会社">
        </p>
        <p class="address">〒901-2101 沖縄県浦添市西原3-18-6</p>
        <a class="footer_tel" href="tel:098-874-3600" style="text-decoration:none;">TEL：098-874-3600</a>
      </div>
      <div class="footer_inner-flexBox-item" id="footer_inner-flexBox-item">
        <ul class="footer-nav">
          ...
          <li class="footer-nav-item">
            <a href="<?php echo esc_url(home_url('/recruit')); ?>" class="btn">
              <span>採用情報</span>
            </a>
          </li>
          <li class="footer-nav-item">
        ...
        <ul class="footer-nav">
          <li class="footer-nav-item">
            <a class="btn hover-none">
              <span>事業内容</span>
            </a>
            <ul class="subMenu">
              <li><a href="<?php echo esc_url(home_url('/facility')); ?>">計装・中央監視制御設備</a></li>
              <li><a href="<?php echo esc_url(home_url('/remote-system')); ?>">遠隔監視制御システム</a></li>
              <li><a href="<?php echo esc_url(home_url('/water')); ?>">水処理装置</a></li>
              <li><a href="<?php echo esc_url(home_url('/pool')); ?>">配水池ロボットの清掃・調査</a></li>
            </ul>
          </li>
        </ul>
        <ul class="footer-nav">
          ...
          <li class="footer-nav-item">
            <a href="<?php echo esc_url(home_url('/privacy-policy')); ?>" class="btn">
    ...
    <p class="copyright">Copyright(C)株式会社沖電システム All Rights Reserved.</p>
  </div>
</footer>
<?php wp_footer(); ?>
...
<script>
  $(document).ready(function() {
    ...
    $('.hamburger').on('click', function() {
      ...
      $('.header_inner-menu').toggleClass('active');
    });
  });
</script>
...
<?php if (!is_front_page()) : ?>
  <script>
    $(window).scroll(function() {
      ...
      let areaTop = $(".aioseo-breadcrumbs").offset().top;
      let triggerPoint = areaTop - 50;
...
<?php if (is_front_page()) : ?>
  <script>
    ...
    $('a[href*="#"]').on('click', function(e) {
      ...
      $('.header_inner-menu').removeClass('active');
    });

    // スクロールに応じたヘッダーの背景変更
    $(window).scroll(function() {
      let scrollTop = $(window).scrollTop();
      let areaTop = $(".top_mission_box").offset().top;
      let triggerPoint = areaTop - 50;
    ...
    function loadedPage() {
      $("div.ripples-3").css('opacity', 0);
      sessionStorage.setItem('visited', 'true');
      setTimeout(function() {
        $("#loading").addClass("loading-none");
        $('div.ripples-3').css('display', 'none');
    ...
    if (!sessionStorage.getItem('visited')) {
      sessionStorage.setItem('visited', 'true');
      $("div.ripples-3").css('opacity', 1);
      $(window).on('load', function() {
        setTimeout(loadedPage, 4500);
        console.log('in');
    ...
    $('div.ripples-3').css('transition', 'opacity .5s ease-in');
